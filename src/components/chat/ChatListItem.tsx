    ...
    <div className="relative group">
      ...
      >
        ...
        <div className="relative shrink-0">
          {isPinned && (
            <div
              className="absolute -top-1 -left-1 z-10 rounded-full p-0.5"
          ...
          <button
            ...
            className={cn(
              ...
              chat.type === "direct" &&
                "hover:ring-2 hover:ring-violet-500 hover:ring-offset-2 hover:ring-offset-zinc-900 active:scale-95 cursor-pointer",
            )}
            style={{
